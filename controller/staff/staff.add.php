...
if(isset($_POST['btnAdd'])) {
    ...
    $teacherO = new AccountObj();
    $teacherM = new AccountMod();
    $teacherO->setAccountObj($_POST['addIdAccount'], $_POST['addAccountName'], $_POST['addBirthday'], $_POST['addAddress'], $_POST['addSex'], $_POST['addPhone'], $_POST['addEmail'],'123', $_POST['addPermission_position']);
    $teacherM->addAccount($teacherO);
    echo'<META http-equiv="refresh" content="0;URL=student.manage.php">';
}
?>
                <!-- Start add student-->
                <div id="addTeacher" class="modal fade " tabindex="-1" role="dialog" aria-labelledby aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body ">
                                <form action="teacher.manage.php" method="post">
