<div class="">
    ...
    <!--Start list student-->
    <?php
    require "../controller/addScoreAcademy/student.table.php";
    ?>
    <!--End list student>
    ...
    <!-- Start add student-->
    <?php
    require "../controller/addScoreAcademy/student.add.php";
    ?>
    <!-- End add student-->

    <!-- Start infor student-->
    <?php
    require "../controller/addScoreAcademy/student.info.php";
    ?>
    <!-- End infor student-->

    <!--Start update student-->
    <?php
    require "../controller/addScoreAcademy/student.update.php";
    ?>
    <!--End update student-->

    <!--Start delete student-->
    <?php
    require "../controller/addScoreAcademy/student.delete.php";
    ?>
    <!--End delete student-->
