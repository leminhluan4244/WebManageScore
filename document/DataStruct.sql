...
CREATE TABLE IF NOT EXISTS `ManagementScore`.`PractiseScores` (
  ...
  PRIMARY KEY (`Account_idAccount`, `scores`, `semester`, `year`),
...
CREATE TABLE IF NOT EXISTS `ManagementScore`.`ScoresAdd` (
  ...
  INDEX `fk_ScoresAdd_Structure1_idx` (`Structure_idItem` ASC),
  CONSTRAINT `fk_ScoresAdd_Structure1`
    FOREIGN KEY (`Structure_idItem`)
    REFERENCES `ManagementScore`.`Structure` (`idItem`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ManagementScore`.`Image` (
  ...
  INDEX `fk_Image_Structure1_idx` (`Structure_idItem` ASC),
  CONSTRAINT `fk_Image_Account1`
    FOREIGN KEY (`Account_idAccount`)
    REFERENCES `ManagementScore`.`Account` (`idAccount`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Image_Structure1`
    FOREIGN KEY (`Structure_idItem`)
    REFERENCES `ManagementScore`.`Structure` (`idItem`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `ManagementScore`.`ScoresAdd_has_Account` (
  `ScoresAdd_idScores` VARCHAR(10) NOT NULL,
  `Account_idAccount` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`ScoresAdd_idScores`, `Account_idAccount`),
  INDEX `fk_ScoresAdd_has_Account_Account1_idx` (`Account_idAccount` ASC),
  INDEX `fk_ScoresAdd_has_Account_ScoresAdd1_idx` (`ScoresAdd_idScores` ASC),
  CONSTRAINT `fk_ScoresAdd_has_Account_ScoresAdd1`
    FOREIGN KEY (`ScoresAdd_idScores`)
    REFERENCES `ManagementScore`.`ScoresAdd` (`idScores`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ManagementScore`.`Transcript_has_Account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ManagementScore`.`Transcript_has_Account` (
  `Transcript_idItem` VARCHAR(10) NOT NULL,
  `Account_idAccount` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`Transcript_idItem`, `Account_idAccount`),
  INDEX `fk_Transcript_has_Account_Account1_idx` (`Account_idAccount` ASC),
  INDEX `fk_Transcript_has_Account_Transcript1_idx` (`Transcript_idItem` ASC),
  CONSTRAINT `fk_Transcript_has_Account_Transcript1`
